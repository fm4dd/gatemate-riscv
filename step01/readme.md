...
```
step01$ make
/home/fm/oss-cad-suite/bin/yosys -ql log/synth.log -p 'read -sv SOC.v ; synth_gatemate -top SOC -luttree -nomx8 -vlog net/SOC_synth.v; write_json net/SOC_synth.json'
...
Info: 	            CFG_CTRL:       0/      1     0%
Info: 	              SERDES:       0/      1     0%
Info: 	              CPE_LT:      12/  40960     0%
Info: 	              CPE_FF:       5/  40960     0%
Info: 	           CPE_RAMIO:       5/  40960     0%
...
/home/fm/oss-cad-suite/bin/iverilog -DBENCH -o SOC.tb -s SOC_tb SOC_tb.v SOC.v 
...
LEDS = 11100001
LEDS = 11100000
SOC_tb.v:26: $finish called at 63 (1s)
```

### Board Programming

There are two options:
- `make prog` writes the bistream to FPGA (not retained after eval board power down)
- `make flash` writes the bistream to Flash (stored permanently, survives power down)
```
$ make prog
